...
object QuadTree:
  ...
  /** Searches the tree for any values whose spatial value intersects with the LineSegment. */
  ...
  /** Searches the tree for any values whose spatial value intersects with the BoundingBox. */
