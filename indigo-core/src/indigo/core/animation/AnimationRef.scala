...
import indigo.core.animation.AnimationAction.JumpToFirstFrame
import indigo.core.animation.AnimationAction.JumpToFrame
import indigo.core.animation.AnimationAction.JumpToLastFrame
import indigo.core.animation.AnimationAction.Play
import indigo.core.animation.AnimationAction.ScrubTo
